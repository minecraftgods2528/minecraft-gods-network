...
export default function Hero() {
  ...
  const copyIp = async () => {
    try {
      await navigator.clipboard.writeText("minecraftgods.wammuhost.fun:26089");
      toast({
        title: "IP Copied!",
        description: "minecraftgods.wammuhost.fun:26089 copied to clipboard.",
        duration: 3000,
      });
    } catch {
      toast({
        title: "Copy Failed",
        description: "Please copy the IP manually: minecraftgods.wammuhost.fun:26089",
        duration: 4000,
      });
    }
  };
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
        ...
        >
              ...
              >
                <div className="text-left">
                  ...
                  <div className="font-mono text-purple-300">
                    minecraftgods.wammuhost.fun:26089
                  </div>
                </div>
          ...
          <div className="mt-8 flex gap-6 text-sm text-gray-400 justify-center">
            <span>
              Port: <strong className="text-white">26089</strong>
            </span>
            <span>•</span>
            <span>
